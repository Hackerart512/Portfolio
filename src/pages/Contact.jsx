                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="font-Syne fw-bold position-relative mb-0 before:content-[''] before:absolute before:h-[35px] md:before:h-[70px] before:w-[35px] md:before:w-[70px] before:bg-[#FFB646] before:top-1 before:rounded-full before:z-[-1] w-[60%] md:w-[100%] ">
                                Let's connect
                            </h3>

                            <div className="contact-info-container mt-4 mt-lg-5 md:w-[70%]">
                                <div className="contact-card border-gray-300 border-b   py-3">
                                    <div className="flex">
                                        ...
                                        <div className="pl-3">
                                            ...
                                            <p className="font-Syne fw-bold flex justify-between mb-0">pavanprajapat241@gmail.com</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="contact-card border-gray-300 border-b  py-3">
                                    <div className="flex">
                                        ...
                                        <div className="pl-3">
                                            ...
                                            <p className="font-Syne fw-bold flex justify-between mb-0">+91 8302088852</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="contact-card border-gray-300 border-b   py-3">
                                    <div className="flex">
                                        ...
                                        <div className="pl-3">
                                            ...
                                            <p className="font-Syne fw-bold flex justify-between mb-0">Pratap nagar aapani shani road, Udaipur(Rajsthan)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6">
                            <form className='mt-4 md:mt-0 '>
                                ...
                                <button className="bg-black py-2 px-3 py-lg-3 px-lg-4 rounded-md text-white hover:bg-white" type="submit">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
